...
def new_seasons_recipe_scraper(file_folder, new_season_category_outfile, new_season_recipe_outfile, new_seasons_full):
    ...
    for counter in range(0, len(category_pages)):
        ...
        recipe_page = driver.find_elements_by_xpath("//div[@class='column1stuff col-xs-12 col-md-4']//descendant::div/descendant::a")
        ...
        while next_page:
            ...
            other_recipe_page = driver.find_elements_by_xpath("//div[@class='column1stuff col-xs-12 col-md-4']//descendant::div/descendant::a")
    ...
    category_mapping.merge(recipe_details, on='new_seasons_id').to_csv(os.path.join(file_folder, new_seasons_full), index=False)
